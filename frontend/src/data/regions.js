...
//
// Nigeria: complete — all 774 LGAs across all 36 states + FCT. This is
// well-established public administrative data (NBS/INEC), high confidence.
//
// Sierra Leone: complete — all 16 districts, low fabrication risk (small,
// well-known list).
//
// Ghana, Benin, Burkina Faso, Côte d'Ivoire, Mali, Togo: NOT populated at
// district/commune/prefecture level. These countries have large district
// counts (Ghana ~216 districts, Côte d'Ivoire ~108 departments, etc.) where
// getting a boundary name wrong is a real risk in a production supply-chain
// tool. Rather than fabricate names that aren't confidently sourced, the LGA
// field falls back to free text for these countries until an authoritative
// source (official gazetteer, GeoNames, or in-country data) is supplied.
export const LGAS_BY_STATE = {
  // ===== Nigeria — 774 LGAs across 36 states + FCT =====
