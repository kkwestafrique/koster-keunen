...
export default function ResetPassword() {
  ...
  if (checking) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#f9fafc] text-[#5a6f9a]" data-testid="reset-password-checking">
        {t('common.loading')}
      </div>
    );
  }
          ...
          <div className="w-full max-w-[400px]">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-5" data-testid="reset-password-form">
              <div className="flex flex-col gap-1.5">
                <Label htmlFor="new-password" className="text-[#5a6f9a] text-sm font-medium">{t('resetPassword.enterPassword')}</Label>
                <div className="relative">
                  <Input
                    id="new-password"
              ...
              <div className="flex flex-col gap-1.5">
                <Label htmlFor="confirm-password" className="text-[#5a6f9a] text-sm font-medium">{t('resetPassword.reenterPassword')}</Label>
                <div className="relative">
                  <Input
                    id="confirm-password"
