...
const ToastViewport = React.forwardRef(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      // Real feedback: an error toast appearing at the bottom of the
      // screen was easy to miss compared to the top -- moved to
      // top-right, which is more consistently in view regardless of
      // where on the page someone's looking when it appears.
